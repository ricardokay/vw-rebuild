...
- **Mobile round part 2 LIVE (2026-09-14):**
  ...
  - **The lead is a chrome setting:** `vw_chrome['mobile_lead']`, either `image-first` (the default, not stored) or `standard` (text-first). It is read by `vw_chrome_mobile_lead()`, and the field sits in the chrome panel. Per-section variants are out of scope.
