<?php
/**
 * Must See Films section front — four-zone custom render.
...
$cats     = [ 15, 16 ]; // must-see-films + netflix-films
...
$vw_lead_slots = vw_curation_resolve( 'section', 'lead', $used_ids, 'must-see-films' );
...
vw_section_browse_all( $cats, 'Must See Films', count( $used_ids ) );
