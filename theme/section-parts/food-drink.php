<?php
/**
 * Food & Drink section front — four-zone custom render.
...
$cats     = [ 13, 14 ]; // food-drink, hungry-social
...
$vw_lead_slots = vw_curation_resolve( 'section', 'lead', $used_ids, 'food-drink' );
...
vw_section_browse_all( $cats, 'Food & Drink', count( $used_ids ) );
