<?php
/**
 * Out N About section front — four-zone custom render.
...
$vw_lead_slots = vw_curation_resolve( 'section', 'lead', $used_ids, 'out-n-about' );
...
vw_section_browse_all( $cats, 'Out N About', count( $used_ids ) );
