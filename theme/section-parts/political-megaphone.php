<?php
/**
 * Political Megaphone section front — four-zone custom render.
...
$vw_lead_slots = vw_curation_resolve( 'section', 'lead', $used_ids, 'political-megaphone' );
...
vw_section_browse_all( $cats, 'Political Megaphone', count( $used_ids ) );
